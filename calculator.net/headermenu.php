...
$APPLICATION->SetTitle("Меню калькулятора");?><?
global $USER;
...
{
    die('<div style="color:red;">ВНИМАНИЕ! Невозможно подключиться к серверу баз данных. </div>');
}
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#getorder', function () {
            ...
            $.each($("textarea.Order-info-comment"), function (i, el) {
               ...
               if (subject.indexOf('ПЕЧАТЬ ФОТОГРАФИИ') >= 0 ) {
                    message.push('Форматы фотографий: ' + getPhotoFormat());
                    message.push('Общее количество фотографий: ' + getPhotoCount());
               } else {}
...
<div class="box" id="headmenu">
 ...
 <img src="" style="width: inherit;">
				...
				<div class="menubut">
 <button class="menubutton mb onready" data-image-path="img/menu_photo.gif" calc-form-path="photoprint.html" form-height="height:579px;">ПЕЧАТЬ ФОТОГРАФИИ </button> <button class="menubutton mb" data-image-path="img/menu_photoondoc.gif" calc-form-path="photoondoc.html" form-height="height:463px;">ФОТО НА ДОКУМЕНТЫ </button> <button class="menubutton mb" data-image-path="img/menu_shtampi.gif" calc-form-path="shtampi.html" form-height="height:170px;">ПЕЧАТИ И ШТАМПЫ </button> <button class="menubutton mb" data-image-path="img/menu_vizitki.gif" calc-form-path="vizitki1.html" form-height="height:335px;">ВИЗИТКИ </button> <button class="menubutton mb" data-image-path="img/menu_listovki.gif" calc-form-path="listovki.html" form-height="height:87px;">ЛИСТОВКИ И ФЛАЕРЫ </button> <button class="menubutton mb" data-image-path="img/menu_shirikoformat.gif" calc-form-path="shirokoformat.html" form-height="height:77px;">ШИРОКОФОРМАТНАЯ ПЕЧАТЬ </button> <button class="menubutton mb" data-image-path="img/menu_holst.gif" calc-form-path="holst.html" form-height="height:502px;">ПЕЧАТЬ НА ХОЛСТЕ </button> <button class="menubutton mb" data-image-path="img/menu_kruzhki.gif" calc-form-path="kruzhki.html" form-height="height:804px;">ПЕЧАТЬ НА КРУЖКАХ </button> <button class="menubutton mb" data-image-path="img/menu_futbolki.gif" calc-form-path="futbolki.html" form-height="height:260px;">ПЕЧАТЬ НА ФУТБОЛКАХ </button> <button class="menubutton mb" data-image-path="img/menu_podushki.gif" calc-form-path="podushka.html" form-height="height:538px;">ПЕЧАТЬ НА ПОДУШКАХ </button>
				</div>
				<div class="menubut1">
 <button class="menubutton mb1" data-image-path="img/menu_tarelki.gif" calc-form-path="tarelka.html" form-height="height:806px;">ПЕЧАТЬ НА ТАРЕЛКАХ </button> <button class="menubutton mb1" data-image-path="img/menu_puzzle.gif" calc-form-path="pazli.html" form-height="height:762px;">ПЕЧАТЬ НА ПАЗЛАХ </button> <button class="menubutton mb1" data-image-path="img/menu_kamen.gif" calc-form-path="kamen.html" form-height="height:539px;">ПЕЧАТИ НА ФОТОКАМНЕ </button> <button class="menubutton mb1" data-image-path="img/menu_other.gif" calc-form-path="other.html" form-height="height:807px;">ДРУГИЕ СУВЕНИРЫ </button> <button class="menubutton mb1" data-image-path="img/menu_calendar.gif" calc-form-path="calendar.html" form-height="height:627px;">КАЛЕНДАРИ </button> <button class="menubutton mb1" data-image-path="" calc-form-path="" form-height="" disabled="">ОТКРЫТКИ </button> <button class="menubutton mb1" data-image-path="img/menu_firmblank.gif" calc-form-path="tablichki.html" form-height="height:297px;">ИЗГОТОВЛЕНИЕ ТАБЛИЧЕК </button> <button class="menubutton mb1" data-image-path="" calc-form-path="" form-height="" disabled="">ФИРМЕННЫЕ БЛАНКИ </button> <button class="menubutton mb1" data-image-path="img/menu_design.gif" calc-form-path="design.html" form-height="height:454px;">ДИЗАЙН </button>
				</div>
