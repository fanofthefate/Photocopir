...
$send_mail = mail("dedtorpedodet@gmail.com", "$tema", "$pismo", "From: site@photocopir.ru" . "\r\n" . "Reply-To: ". $mail ."\r\n". $headers,"-f site@photocopir.ru");

$send_mail = mail($mail, $sbj,utf("Информация о заказе:"). '<br>' .  utf($string) . '<br>' . utf($info_s) . '<br>' . utf('Прикрепленные файлы:') . '<br>' . $filesString, 'From: site@photocopir.ru' . "\r\n" .
    'Reply-To: '. $to . "\r\n" .$headers);
