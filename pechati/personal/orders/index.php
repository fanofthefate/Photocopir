...
$arSelect = Array("ID", "NAME","DATE_CREATE", "PREVIEW_TEXT","PROPERTY_37","PROPERTY_36","PROPERTY_35","DETAIL_TEXT"); // Указываем список параметров, которые будем использовать
