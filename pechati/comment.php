...
"></span></div>
                ...
                ;
                    color: #fff
                ;
                ">Стоимость<span></span></span></div>
            <form action="#" method="POST" onsubmit="return false;" style="
    float: right;
    display: inline-block;
">
                <button type="submit" id="getorder" name="get_order">ПЕРЕЙТИ К ОФОРМЛЕНИЮ ЗАКАЗА</button>
            </form>
    ...
    <script type="text/template" id="qq-template-manual-trigger">
        <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Перетащите ваши файлы сюда">
    ...
    position: absolute;">
                    ...
                    <select class="recalculate file-format showhide" name="" id="" style="    position: absolute;">
                        ...
                        <option value="А3">A3</option>
                        <option value="А2">A2</option>
                        <option value="А1">A1</option>
                    </select>
